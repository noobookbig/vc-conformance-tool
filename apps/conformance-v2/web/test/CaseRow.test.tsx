...
describe('CaseRow', () => {
  ...
  it('renders the failing case with the failing message, status, and a copyable response body', () => {
    ...
    expect(screen.getByTestId('case-body-B.2').textContent).toMatch(/expected 200, got 404/);
    expect(screen.getByTestId('case-body-B.2').textContent).toMatch(/404/);
    const body = screen.getByTestId('case-response-B.2');
